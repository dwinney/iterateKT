// Isobars relevant for the decay of meson with JP = 0- into 3pi
// Specifically this is the delta I = 1 transition for eta -> 3pi
// This amplitude 
// 
// ------------------------------------------------------------------------------
...
{ 
    // Isobar id's
    static const int kdI1_S0 = 0;
    static const int kdI1_P1 = 1;
    static const int kdI1_S2 = 2;
    ...
    inline static const settings default_settings()
    {
        ...
        std::array<double,2> _exclusion_offsets  = {0.5, 7};
    ...
    class dI1_transition : public raw_amplitude
    {
        public: 
        
        dI1_transition(kinematics kin, std::string id) : raw_amplitude(kin,id)
        {};
    ...
    // -----------------------------------------------------------------------
    // I = 0, S-wave isobar
    class dI1_transition::S0_wave : public raw_isobar
    {
        public: 
    ...
    // -----------------------------------------------------------------------
    // I = 1, P-wave isobar
    class dI1_transition::P1_wave : public raw_isobar
    {
        public: 
    ...
    // -----------------------------------------------------------------------
    // I = 2, S-wave isobar
    class dI1_transition::S2_wave : public raw_isobar
    {
        public: 
