...
void plot_pars()
{
    ...
    p1.add_data(   minimal_alpha[0],  {   minimal_alpha[1]/1E3,    minimal_alpha[2]/1E3},  square(jpacColor::Blue,         "Minimal"));
    p1.save("Nc.pdf");
    ...
    p2.add_data(   minimal_moddelta[0], {   minimal_moddelta[1]/1E3,    minimal_moddelta[2]/1E3},  square(jpacColor::Red,           "Minimal"));
    p2.save("modNd.pdf");
    ...
    p3.add_data(   minimal_argdelta[0], {   minimal_argdelta[1],    minimal_argdelta[2]},  square(jpacColor::Green,         "Minimal"));
    p3.save("argNd.pdf");
    ...
    p6.add_data(nonminimal_beta[0], {nonminimal_beta[1]/1E3, nonminimal_beta[2]/1E3},   square(jpacColor::Orange));
    p6.save("Ncp.pdf");
};