...
void fit()
{
    ...
    using kaon::experiment;

    data_set charged = kaon::daltiz_expansion(experiment::Charged_NA48_2007);
    data_set neutral = kaon::dalitz_expansion(experiment::Neutral_PDG_AVG);
